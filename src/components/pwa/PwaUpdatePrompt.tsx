...
export function PwaUpdatePrompt() {
  ...
  return (
    <div className="fixed inset-x-4 bottom-24 z-[70] mx-auto flex max-w-sm items-center gap-3 rounded-2xl border border-border bg-card p-4 shadow-2xl animate-toast-in sm:bottom-6">
