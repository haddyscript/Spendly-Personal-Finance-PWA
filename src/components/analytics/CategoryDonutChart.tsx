  ...
  return (
    <div>
      ...
      <div className="mt-5 flex flex-col gap-2">
        {data.map((slice) => (
          <div key={slice.categoryId} className="flex items-center gap-2.5 text-sm">
            ...
            <span className="tabular-nums text-muted-foreground">{calculatePercentage(slice.totalMinor, totalMinor).toFixed(0)}%</span>
          </div>
        ))}
      </div>
    </div>
